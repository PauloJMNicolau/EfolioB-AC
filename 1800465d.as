...
ORIG        8000h
N           WORD    4                                                       ;Tamanho da Linha/Coluna Matriz
...
InicioDM:                       MOV R4, Input                               ;Endereço Posição inicial vetor
                                ...
                                MOV R6, M[N]                                ;Valor do Tamanho da linha/coluna da matriz
    ...
    RestoZero:                  MOV R6, M[N]                                ;Corrige Valor da Coluna
                                JMP Coninuar
    RestoDiferenteZero:         INC R5                                      ;Corrige valor de Linha                            
    Coninuar:                   MOV R4, M[N]                                ;Posição Final do espaço Vazio (NxN)
                                SUB R5, R4                                  ;Linha - N 
                                BR.P R5Positivo
                                NEG R5                                      ;Coloca R5 a Positivo
        R5Positivo:             SUB R6, R4                                  ;Coluna - N
                                BR.P R6Positivo
...
InicioPR:                       CMP R1, FFFFh                               ;Verifica se valor de distancia Manhattan é valido
                                ...
                                DIV R4, R5                                  ;
                                CMP R5, R0                                  ;Verifica se o resto é 0 ou divisao por 0
                                JMP.O ErroPR
                                BR.NZ Impar
